package net.abhiCoders.ToDo.Adapters;
...
import net.abhiCoders.ToDo.AddNewTask;
import net.abhiCoders.ToDo.MainActivity;
import net.abhiCoders.ToDo.Model.ToDoModel;
import net.abhiCoders.ToDo.R;
...
public class ToDoAdapter extends RecyclerView.Adapter<ToDoAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        holder.task.setText(item.getT());
        holder.task.setChecked(toBoolean(item.getS()));
